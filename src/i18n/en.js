...
const translations = {
  ...
  'embedder.options.label.units.accessibilityAreas.walk': 'Show accessibility areas (walking)',
  'embedder.options.label.units.accessibilityAreas.bicycle': 'Show accessibility areas (cycling)',
  ...
  'mobilityPlatform.content.parkingChargeZones.price.saturday': 'Toll charge on saturdays: {value}',
  'mobilityPlatform.content.parkingChargeZones.price.sunday': 'Toll charge on sundays: {value}',
