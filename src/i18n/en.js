...
const translations = {
  ...
  'dev.incorrect.password': 'Incorrect password',
  'dev.password.error': 'Password verification error',
  'dev.enter.password': 'Enter password',
  'dev.login': 'Login',
  'dev.login.title': 'Servicemap testsite login',
