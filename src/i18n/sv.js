...
const translations = {
  ...
  'area.tab.mobilityTest.results': 'Mobilitetsprofiler av Åbo',
  ...
  'area.mobilityResults.link.text': 'turku.fi/liikkumistesti (ny flik)',
  ...
  'home.buttons.mobilityPlatformSettings': 'Bekanta dig med de mångsidiga alternativen för trafik och mobilitet',
  ...
  'search.suggestions.addresses': 'Sök med adress',
  ...
  'mobilityPlatform.menu.showBicycleStands': 'Cykelparkering (icke-ramlåsbara)',
  'mobilityPlatform.menu.show.hullLockableStands': 'Cykelparkering (ramlåsbara)',
  ...
  'mobilityPlatform.content.parkingChargeZones.price.saturday': 'Avgiftsbelagd lördagar: {value}',
  'mobilityPlatform.content.parkingChargeZones.price.sunday': 'Avgiftsbelagd söndagar: {value}',
  ...
  'mobilityPlatform.content.marinas.berthsCount': 'Antal båtplatser: {value}',
  'mobilityPlatform.content.marinas.winterStorage': 'Antal vinterförvaringplatser: {value}',
  ...
  'mobilityPlatform.content.boatParking.title': 'Båtparkeringplats',
  'mobilityPlatform.content.guestHarbour.title': 'Gästhamn',
  'mobilityPlatform.content.guestHarbour.info': 'Turku Gästhamn ligger precis intill centrum, på Västra Strandgatan 57.',
  ...
  'mobilityPlatform.info.parkingChargeZones.zone.1': 'Zon ett (kärncentrum): 3,60 €/timme (från 1.1.2023)',
  'mobilityPlatform.info.parkingChargeZones.zone.2': 'Zon två: 1,80 €/timme (från 1.1.2023)',
