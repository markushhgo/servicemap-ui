...
const EcoCounterContent = ({ classes, intl, stationId, stationName, isTelraam }) => {
  ...
  const formatWeeks = weekValue => moment().day('Monday').year(selectedYear).week(weekValue).format('DD.MM');
